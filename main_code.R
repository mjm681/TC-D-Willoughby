...
all_colnames <- list(colnames_101, colnames_102, colnames_3a02, colnames_3a06, colnames_3a07, colnames_3a08,
                    colnames_3a10, colnames_3a17, colnames_3b01, colnames_3b02, colnames_3b05, colnames_3b06,
                    colnames_3b07, colnames_3b08, colnames_401, colnames_402, colnames_403, colnames_404, 
                    colnames_405, colnames_406, colnames_407, colnames_408, colnames_409, colnames_410)

##### 

headings <- c("Animal name",
              "Animal number",
              "Animal type",
              "Attachment ease",
              "Average milkings",
